...
export default function Pools({ serverSideEventData }) {
	...
	return (
		<>
			<Metadata
				title={`${serverSideEventData.name}: pools - Instant Fencing`}
				url={`/event${serverSideEventData.id}/pools`}
			/>
			<NavBar
				tabs={true}
			...
			<div className="mainContent">
				...
				<div className="card column">
					<p>
						<span className="success-text bold">V</span>: victories
					</p>
					<p>
						<span className="fail-text bold">D</span>: defeats
					</p>
					<p>
						<span className="bold">M</span>: missing bouts
					</p>
				</div>
			</div>
		</>
